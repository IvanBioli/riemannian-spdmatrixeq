function eqn = mess_get_bilinear_rail_modified(k)
...
% Model Parameters
lambda = 26.4; lambda = lambda / 100;
c = 7620.0; c = c / 100;
rho = 654.0; rho = rho / 10;
gamma_k = 7.0164; gamma_k = gamma_k / 10; 

u_ext = 0.02; u_ext = u_ext * 100;
